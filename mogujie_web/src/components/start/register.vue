<template>
  <div>
    <Navbar class="nav-bar">
      <div slot="left" class="left" @click="goLogin">
    ...
    async blurAccount() {
      if (this.msg.user_account) {
        ...
        if (result.data.success) {
          ...
          (this.isAccount = false), (this.Account = "账号重复，请重新输入");
          this.isLoading = false;
        }
      } else {
        (this.isAccount = false), (this.Account = "请输入账号");
      }
    },
    // 验证密码
    blurPassword() {
      if (!this.msg.user_password) {
        (this.isPassword = false), (this.Password = "请输入密码");
      } else {
        (this.isPassword = true), (this.Password = "密码通过");
      }
    },
    // 注册账号
    async goRegister() {
