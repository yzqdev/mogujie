  ...
  methods: {
    ...
    refresh() {
      ...
      this.$nextTick(function () {
        document.getElementsByTagName("img")[0].style.transform =
          "rotate(0deg)";
        document.getElementsByTagName("img")[1].style.transform =
          "rotate(0deg)";
        document.getElementsByTagName("img")[2].style.transform =
          "rotate(0deg)";
        document.getElementsByTagName("img")[3].style.transform =
          "rotate(0deg)";
      });
    ...
    rotate(index) {
      ...
      document.getElementsByTagName("img")[
        index
      ].style.transform = `rotate(${this.deg[index]}deg)`;
