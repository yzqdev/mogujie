  ...
  methods: {
    ...
    ring(ctx) {
      ...
      ctx.arc(
        ...
        250,
        this.radius,
        this.ringBegin * Math.PI,
        this.ringEnd * Math.PI
      );
      ctx.stroke();
    },
    /* eslint-disable no-new */
    smallRing(ctx) {
      const a = new SmallRing(
        this.smallBegin1 * Math.PI,
        this.smallEnd1 * Math.PI
      );
      const b = new SmallRing(
        this.smallBegin2 * Math.PI,
        this.smallEnd2 * Math.PI
      );
      a.active(ctx);
      b.active(ctx);
    },
    ...
    point() {
      if (
        this.smallEnd1 === this.ringBegin ||
        this.smallEnd1 - this.ringBegin === 2
      ) {
      ...
      if (
        this.smallEnd2 === this.ringBegin ||
        this.smallEnd2 - this.ringBegin === 2
      ) {
