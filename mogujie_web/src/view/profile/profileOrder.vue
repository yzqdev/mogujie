      ...
      <div v-if="selectOrder.length">
        ...
        >
          <div class="goodsListDiv">
            <div>
              <span style="font-weight: 600">{{ orderDes[orderIndex] }}</span
              ><span></span>
            </div>
            <div
              ...
              class="goodsListShop"
            >
              <div style="font-size: 12px; color: #999999; margin-bottom: 3px">
                <span>{{ item1.shop }}</span
                ><span
